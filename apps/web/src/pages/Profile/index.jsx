...
import {Award, Ban, BookOpen, Camera, ChevronRight, Handshake, Heart, Lock, LogOut, Moon, Pencil, Users,} from 'lucide-react';
    ...
    return (
        <div className={styles.page}>
            ...
            <div className={styles.group}>
                ...
                <Link to={WEB_ROUTES.PUBLICATIONS} className={styles.item}>
                    <span className={styles.itemLeft}>
                        <span className={styles.iconBox}><Handshake size={20}/></span>
                        <span className={styles.itemLabel}>My Trades</span>
                    </span>
                    <ChevronRight size={18} className={styles.chevron}/>
                </Link>
            </div>
