...
// --- 1. Create the Visibility Context ---
...
type TabItemProps = {
  ...
  label: string;
  iconName: string;
  themeColors: typeof Colors.light; // We pass the dynamic theme here
};
...
const TabItem = ({ isFocused, onPress, label, iconName, themeColors }: TabItemProps) => {
  ...
  const activePillColor = themeColors?.tabBarPillActive || '#2C2C2E';
